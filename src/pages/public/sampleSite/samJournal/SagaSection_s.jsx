...
import SagaForm from '../samForms/SagaForm_s'
import SagaFormAlert from './SagaFormAlert'
import { selectStatus,
  openSagaForm
...
const SagaFormWrapper= styled('div')({
...
export default function SagaSection(props) {
  ...
  let sagaViewId = useSelector(selectStatus).view.saga.sagaId
  ...
  const handleClick = (id)=>{
   ...
   console.log('[ 00000000000000000000000000000000000000] myVar ', sectionId);
    dispatch(openSagaForm(sectionId))
