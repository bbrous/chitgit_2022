...
import {deleteTask} from '../../../../app/redux/taskRedux/sam_tasksSlice'
...
import sam_journalSlice from '../../../../app/redux/journalRedux/sam_journalSlice'
...
function Edit(props) {
  ...
  const handleDelete = (id, source) =>{
    ...
    // if(source === 'task') {
    //   console.log('[ where ] your gotter task here ');
    let data = {
      id:id,
      source: source,
   ...
   // #################   PROBLEM HERE ##########################
    ...
    console.log('[ DeleteIcon  ] id ', id);
    console.log('[ DeleteIcon  ] source ', source);
