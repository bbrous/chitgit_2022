...
const SampleJournalSections =  [
  ...
  // Begin log_1 ------------------------- >>
 
    {
      ...
      content: '"<p>So I read that there are lot’s of <strong>benefits</strong> to keeping a journal … things like helps achieve goals, inspiration, more self-confidence, improve memory, more creativity… blah blah blah.&nbsp;</p><p>&nbsp;</p><p>The reason I liked is that maybe it can reduce stress.</p><p>&nbsp;</p><p>I do like the idea of keeping track of things so here goes.</p><p>  </p><p><br></p>',
