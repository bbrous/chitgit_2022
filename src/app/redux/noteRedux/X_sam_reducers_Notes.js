...
import {  
        ...
        // console.log('[reducerSpotlights] initial spotlights are: ', InitialStore.notes)

        let notesArray = InitialStore

        const initialState =  notesArray



const reducer_Notes = produce((draft = initialState, action) => {
